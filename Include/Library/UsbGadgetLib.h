...
typedef USB_DEVICE_QUALIFIER_DESCRIPTOR*
(EFIAPI *USB_GADGET_GET_DEVICE_QUALIFIER_DESCRIPTOR)(
  USB_GADGET *This
);

typedef USB_BOS_DESCRIPTOR*
(EFIAPI *USB_GADGET_GET_BOS_DESCRIPTOR)(
  USB_GADGET *This
);
...
struct _USB_GADGET {
  ...
  USB_GADGET_GET_DEVICE_QUALIFIER_DESCRIPTOR GetDeviceQualifierDescriptor;
  USB_GADGET_GET_BOS_DESCRIPTOR GetBosDescriptor;
